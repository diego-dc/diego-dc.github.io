    ...
    return (
        ...
        <div className='absolute inset-0 z-1'>
            ...
            <div className="fixed aspect-square w-full sm:w-3/4 md:w-10/12 lg:w-1/6 xl:min-h-[25%] xl:w-auto xl:min-w-[15%] -right-1/2 -top-8 sm:-right-1/4 sm:-top-20 lg:right-[55%] lg:top-0 spotlight-top-left">
                <div className="bg-[--color-tertiary] size-full rounded-full opacity-35 blur-[100px] transition [transform:translate3d(0,0,0)] md:blur-[150px] lg:blur-[100px] xl:blur-[200px]"></div>
            </div>
            ...
            <div className="fixed aspect-square w-full sm:w-3/4 md:w-10/12 lg:w-1/6 xl:min-h-[30%] xl:w-auto xl:min-w-[20%] -bottom-8 -left-1/2 sm:-bottom-20 sm:-left-1/4 lg:bottom-0 lg:left-[55%] spotlight-bottom-right">
                <div className="bg-[--color-tertiary] size-full rounded-full opacity-30 blur-[100px] transition [transform:translate3d(0,0,0)] md:blur-[150px] lg:blur-[100px] xl:blur-[200px]"></div>
            </div>
        </div>
    );
};

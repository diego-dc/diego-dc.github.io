...
const ThumbnailAbout = () => {
  useGSAP(() => {
    ...
    const thumbnail_title2 =
      gsap.utils.toArray<HTMLElement>(".thumbnail-title2");
    const titles = gsap.utils.toArray<HTMLElement>(".text-variant");

    const masterTimeline = gsap.timeline();
    const tl2 = gsap.timeline({ repeat: -1, delay: 3.2 });
  ...
  return (
    <div className="container flex flex-col items-center justify-center w-full title-container">
      <div className="mb-2 text-3xl sm:text-3xl md:text-6xl lg:text-6xl xl:text-7xl 2xl:text-8xl">
        <span className="thumbnail-title">Hey! my name is </span>
        <span className="text-[var(--color-highlight)] text-name inline-block">
          Diego
        </span>
        .
      </div>
      <div className="mb-2 text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl thumbnail-title2">
        I&apos;m dedicated to coding with
      </div>
      <div className="container sm:mt-2 md:mt-6 lg:mt-10">
        <div className="text-wrapper">
          <div className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl mb-2 text-[var(--color-highlight)] uppercase text-variant">
            Creativity
          </div>
          <div className="text-2xl sm:text-3xl md:text-5xl lg:text-6xl xl:text-7xl 2xl:text-8xl mb-2 text-[var(--color-highlight)] uppercase text-variant">
            Innovation

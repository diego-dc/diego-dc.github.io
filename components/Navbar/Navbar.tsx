          ...
          `}>
            ...
            {isClick && (
                <div className="flex flex-col items-center justify-center w-screen h-screen gap-32 text-center">
                    ...
                    <div className="">
                            <div className="flex items-center ml-4 space-x-12">
                                <a href="https://github.com/diego-dc" target="_blank" className="cursor-pointer text-slate-400 transition duration-300 ease-linear hover:text-[var(--color-highlight)] hover:shadow-2xl hover:scale-110 active:scale-90">
                                    <svg 
                                        xmlns="http://www.w3.org/2000/svg" 
                                        viewBox="0 0 496 512"
                                        width={30}
                                ...
                                <a href="mailto:diegcavi21@gmail.com" className="cursor-pointer text-slate-400 transition duration-300 ease-linear hover:text-[var(--color-highlight)] hover:shadow-2xl hover:scale-110 active:scale-90">
                                    <svg 
                                        xmlns="http://www.w3.org/2000/svg" 
                                        viewBox="0 0 512 512"
                                        width={30}
                                ...
                                <a href="https://linkedin.com/in/diego-caviedes-aguirre-022b6b225" target="_blank" className="cursor-pointer text-slate-400 transition duration-300 ease-linear hover:text-[var(--color-highlight)] hover:shadow-2xl hover:scale-110 active:scale-90">
                                    <svg 
                                        xmlns="http://www.w3.org/2000/svg" 
                                        viewBox="0 0 448 512"
                                        width={30}
